pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b~convertcharacterinteger.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~convertcharacterinteger.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_convertcharacterinteger");
...
--  BEGIN Object file/option list
   --   .\convertcharacterinteger.o
   --   -L.\
   --   -LF:\Profile\Dropbox\Dropbox\SHSU\DataStructures\Labs\Lab1\
   --   -LF:/GNAT/2016/lib/gcc/i686-pc-mingw32/4.9.4/adalib/
   --   -static
   --   -lgnat
   --   -Wl,--stack=0x2000000
