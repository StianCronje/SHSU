...
public class StackMachine {
    ...
    public void runInstruction(int instr, int operand)
    {
        ...
        case PUSH:
            ...
            //System.out.println("Push constant of " + operand + " to stack");
            stack.push(operand);
            break;
            
        case RVALUE:
            // push the contents of variable to stack
            //System.out.println("Push variable " + operand + " to stack");
            stack.push(data[operand]);
            break;
        case LVALUE:
            // push the address of the variable to stack
            //System.out.println("Push address of variable " + operand+ " to stack");
        ...
        case STO:
            ...
            lvalue = stack.pop();
            data[lvalue] = rvalue;
            //System.out.println("Store " + rvalue + " at address " + lvalue);
            break;  
        ...
        case COPY:
            ...
            rvalue = stack.peek();
            stack.push(rvalue);
            //System.out.println("Copy " + rvalue);
            break;
        ...
        // pop the top two values off the stack, subtract them, and push the result
            ...
            stack.push(sub);
            //System.out.println(lvalue + " - " + rvalue + " = " + sub);
            break;
        ...
        case DIV:
            ...
            stack.push(div);
            //System.out.println(lvalue + " / " + rvalue + " = " + div);
            break;
        ...
        default: // oops!
            System.out.println("Opcode not implemented");
            System.exit(instr);
        }
        if (ir == 0)
